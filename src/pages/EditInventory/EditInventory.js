...
const EditInventory = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await axios.put(
      `http://localhost:5050/inventories/${id}`,
      formData
    );

    window.location.assign("/inventories");
  };
  ...
  return (
    <>
      <div className="edit-inv">
        <div className="edit-inv-header">
          <Link to="/inventories">
            <img
              className="edit-inv-header__arrow"
              src={arrow}
              alt="arrow-icon"
            ></img>
          </Link>

          <h1 className="edit-inv-header__title">Edit Inventory Item</h1>
        </div>
        <form className="edit-inv__form" onSubmit={handleChange}>
          <div className="edit-inv__wrapper">
          ...
          <div className="item-submit">
            ...
            <button onClick={handleSubmit} className="item-submit__add">
              Save
            </button>
          </div>
        </form>
